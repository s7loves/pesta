...
// jsUriTemplate will have localhost:7821/ and %js% substituted.
// No locked domain special cases, but jsUriTemplate must
// never conflict with a lockedDomainSuffix.
"gadgets.jsUriTemplate" : "http://localhost:7821/gadgets/js/%js%",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://localhost:7821/gadgets/proxy?refresh=%refresh%&url=%url%",
    "jsonProxyUrl" : "http://localhost:7821/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://localhost:7821/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://localhost:7821/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
  ...
  "opensocial-0.8" : {
    ...
    "path" : "http://localhost:7821/social",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
