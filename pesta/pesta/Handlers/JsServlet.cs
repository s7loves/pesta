...
namespace Pesta.Handlers
{
    ...
    {
        private GadgetFeatureRegistry registry = GadgetFeatureRegistry.Instance;
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            String resourceName = req.RawUrl.Substring(req.RawUrl.LastIndexOf('/') + 1);
            ...
            {
                foreach (string item in resourceName.Split('_'))
                {
                    needed.Add(item);
                }
