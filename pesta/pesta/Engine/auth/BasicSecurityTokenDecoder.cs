...
namespace Pesta.Engine.auth
{
    ...
    public class BasicSecurityTokenDecoder : SecurityTokenDecoder
    {
        ...
        private static readonly int DOMAIN_INDEX = 3;
        private static readonly int APP_URL_INDEX = 4;
        private static readonly int MODULE_ID_INDEX = 5;
        private static readonly int CONTAINER_ID_INDEX = 6;
        internal static readonly int TOKEN_COUNT = CONTAINER_ID_INDEX + 1;
