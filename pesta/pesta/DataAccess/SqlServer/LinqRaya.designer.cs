...
namespace Pesta.DataAccess.SqlServer
{
    ...
    partial void OncreatedChanged();
		...
		[Association(Name="application_activity", Storage="_application", ThisKey="app_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		...
		[Association(Name="person_activity", Storage="_person", ThisKey="person_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnurlChanged();
		...
		[Column(Storage="_media_type", DbType="VarChar(16) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="activity_activity_media_item", Storage="_activity", ThisKey="activity_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnvalueChanged();
		...
		[Association(Name="application_application_setting", Storage="_application", ThisKey="application_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public application application
		{
			get
			{
		...
		[Association(Name="person_application_setting", Storage="_person", ThisKey="person_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public person person
		{
			get
			{
    ...
    partial void OntypeChanged();
		...
		[Column(Storage="_author", DbType="VarChar(1024)")]
		...
		[Column(Storage="_scrolling", DbType="VarChar(8) NOT NULL", CanBeNull=false)]
    ...
    partial void OnhashChanged();
		...
		[Column(Storage="_hash", DbType="VarChar(41) NOT NULL", CanBeNull=false)]
		public string hash
		{
			get
			{
		...
		[Association(Name="person_authenticated", Storage="_person", ThisKey="person_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public person person
		{
			get
			{
    ...
    partial void OnpersonidChanged();
		...
		[Column(Storage="_fb_userid", DbType="BigInt NOT NULL")]
		...
		[Association(Name="person_fb_user", Storage="_person", ThisKey="personid", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public person person
		{
			get
			{
    ...
    partial void Onimage_typeChanged();
		...
		[Column(Storage="_image_type", DbType="Int NOT NULL")]
    ...
    partial void OncreatedChanged();
		...
		[Column(Storage="_sender", DbType="Int NOT NULL")]
		public int sender
		{
			get
			{
    ...
    partial void Onuser_idChanged();
		...
		[Column(Storage="_openid_url", DbType="VarChar(255) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_user_id", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
    ...
    partial void OnwebpageChanged();
		...
		[Association(Name="address_organization", Storage="_address", ThisKey="address_id", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void Onapplication_idChanged();
		...
		[Association(Name="application_person_application", Storage="_application", ThisKey="application_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public application application
		{
			get
			{
		...
		[Association(Name="person_person_application", Storage="_person", ThisKey="person_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public person person
		{
			get
			{
    ...
    partial void Onlast_nameChanged();
		...
		[Column(Storage="_email_hash", DbType="VarChar(128) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_looking_for", DbType="Int")]
		...
		[Association(Name="person_authenticated", Storage="_authenticated", ThisKey="id", OtherKey="person_id", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="person_fb_user", Storage="_fb_user", ThisKey="id", OtherKey="personid", IsUnique=true, IsForeignKey=false)]
